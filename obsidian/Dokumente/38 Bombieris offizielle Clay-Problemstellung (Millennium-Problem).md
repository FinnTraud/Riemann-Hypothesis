...
tags:
  ...
  - "thema/bombieri"
  - "thema/clay"
  - "thema/millennium-problem"
  - "thema/official-statement"
quelle: docs/38_Bombieri_official_problem_statement.md
---

> [!info] Navigation
> **Karte:** [[MOC M – Meta ∕ 'Bulletproof'-Schicht (Obstruktionen, Synthese, Verifikation)]] · **Kategorie:** Referenz · **Status:** `REFERENZ`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/38_Bombieri_official_problem_statement.md`
...
- Enthält Bombieris Diskussion des Funktionenkörper-Falls (Weil/Deligne, Dok. [[18 Weil-Vermutungen – RH über endlichen Körpern (Deligne) – BEWIESEN|18]]) als Motivation und der spektralen Interpretation (Hilbert–Pólya, Dok. [[05 Die Hilbert–Pólya-Vermutung (spektraler Ansatz)|05]]).
- Definiert implizit die Akzeptanzkriterien des Clay-Instituts (Publikation + 2 Jahre Bewährung, vgl. Dok. [[27 Weitere umstrittene, zurückgezogene & fehlerhafte Beweisbehauptungen|27]]).
...
- `[OFFEN]` [[claim-rh]] — Alle nicht-trivialen Nullstellen von ζ(s) haben Re(s)=1/2.
