...
tags:
  ...
  - "thema/2024"
  - "thema/decoupling"
  - "thema/dirichlet-polynomials"
  - "thema/guth-maynard"
  - "thema/zero-density"
quelle: docs/22_Guth_Maynard_2024.md
---

> [!info] Navigation
> **Karte:** [[MOC H – Aktuelle Durchbrüche]] · **Kategorie:** Durchbrüche · **Status:** `BEWIESEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/22_Guth_Maynard_2024.md`
...
- Belebt die Hoffnung, dass moderne Harmonische-Analysis-Methoden weitere Exponenten verbessern (vgl. Dichte-Hypothese, Dok. [[17 Lindelöf-Hypothese & Dichte-Hypothese|17]]).
...
- **nutzt** → [[17 Lindelöf-Hypothese & Dichte-Hypothese]] — *Guth–Maynard verbessert Dichte-Abschätzungen Richtung Dichte-Hypothese.*

### Eingehende Relationen

- **wird genutzt von** ← [[54 Maschinengestützte Zahlentheorie – ANTEDB, systematische Exponenten-Optimierung und formalisierter Primzahl]] — *Additive Energie der Nullstellen ist die Guth-Maynard-Zwischengroesse.*
- **wird gestützt durch** ← [[49 Live-Front der analytischen Zahlentheorie (2019–2026)]] — *Live-Front: explizite Dichte, Subkonvexität, Momente.*

### Belegte Aussagen (Claims)

- `[BEWIESEN]` [[claim-guth-maynard]] — N(3/4,T) ≪ T^{13/25+o(1)} (Verbesserung von Inghams 3/5).
