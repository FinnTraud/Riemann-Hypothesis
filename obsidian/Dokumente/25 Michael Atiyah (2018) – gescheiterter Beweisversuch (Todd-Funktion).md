...
tags:
  ...
  - "thema/atiyah"
  - "thema/failed"
  - "thema/fine-structure-constant"
  - "thema/todd-function"
quelle: docs/25_Atiyah_2018_failed_proof.md
---

> [!info] Navigation
> **Karte:** [[MOC J – Gescheiterte ∕ umstrittene Beweise]] · **Kategorie:** Gescheiterte Beweise · **Status:** `WIDERLEGT`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/25_Atiyah_2018_failed_proof.md`
...
- Lehre für KI-Kontext: Auch menschliche Genies produzieren falsche "Durchbrüche"; strenge Verifikation ist unverzichtbar (vgl. Dok. [[27 Weitere umstrittene, zurückgezogene & fehlerhafte Beweisbehauptungen|27]], [[28 KI ∕ Machine Learning und die Riemann-Vermutung|28]]).
...
### Einordnung
Strukturell ein Positivitäts-/Reellwurzeligkeits-Ansatz wie viele (Dok. [[14 Li-Kriterium, Bombieri–Lagarias & Weil-Positivität|14]], [[20 Louis de Branges – Hilberträume ganzer Funktionen (mehrfach gescheiterte Beweise)|20]]), aber der entscheidende analytische Schritt ist nicht haltbar. Lehre: Auch ein Fields-Medaillen-Träger ersetzt keinen prüfbaren Beweis.
...
- **wird widerlegt durch** → [[Riemann-Vermutung (RH)]] — *Atiyah 2018: gescheitert (Liouville-Verletzung).*

### Belegte Aussagen (Claims)

- `[WIDERLEGT]` [[claim-atiyah]] — Atiyahs Todd-Funktions-Beweis (2018) ist gültig.
