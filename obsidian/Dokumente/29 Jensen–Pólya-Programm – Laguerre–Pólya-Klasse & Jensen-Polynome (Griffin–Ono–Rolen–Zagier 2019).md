...
tags:
  ...
  - "status/open"
  - "thema/griffin-ono-rolen-zagier"
  - "thema/hyperbolicity"
  - "thema/jensen-polya"
  - "thema/laguerre-polya"
  - "thema/turan-inequalities"
quelle: docs/29_Jensen_Polya_Laguerre_Polya_GORZ.md
---

> [!info] Navigation
> **Karte:** [[MOC L – Weitere aktive Lösungsprogramme (potenziell beweisrelevant)]] · **Kategorie:** Lösungsprogramme · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/29_Jensen_Polya_Laguerre_Polya_GORZ.md`
...
- Eng verwandt mit der **de-Bruijn–Newman-Konstante** (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]): Λ ≤ 0 ⟺ ξ ∈ Laguerre–Pólya. Pólyas Untersuchung von Fourier-Transformierten positiver Funktionen ist die gemeinsame Wurzel.
- Positivitäts-/Reellwurzeligkeits-Leitmotiv wie bei Weil-Positivität (Dok. [[14 Li-Kriterium, Bombieri–Lagarias & Weil-Positivität|14]]) und de Branges (Dok. [[20 Louis de Branges – Hilberträume ganzer Funktionen (mehrfach gescheiterte Beweise)|20]]).
...
- **ist äquivalent zu** → [[Riemann-Vermutung (RH)]] — *ξ∈Laguerre-Pólya / Jensen-Hyperbolizität ⟺ RH.*
- **nutzt** → [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15]] — *Laguerre-Pólya ⟺ Λ≤0; gemeinsame Pólya-Wurzel.*

### Belegte Aussagen (Claims)

- `[BEWIESEN]` [[claim-jensen-lp]] — RH ⟺ ξ ∈ Laguerre–Pólya-Klasse ⟺ alle Jensen-Polynome hyperbolisch.
