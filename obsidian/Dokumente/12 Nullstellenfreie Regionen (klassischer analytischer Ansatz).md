...
tags:
  ...
  - "kategorie/analytic"
  - "status/open"
  - "thema/de-la-vallee-poussin"
  - "thema/prime-number-theorem"
  - "thema/vinogradov-korobov"
  - "thema/zero-free-region"
quelle: docs/12_zero_free_regions.md
---

> [!info] Navigation
> **Karte:** [[MOC D – Analytische Ansätze & äquivalente Kriterien]] · **Kategorie:** Analytische Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/12_zero_free_regions.md`
...
- Der Vinogradov–Korobov-Exponent (2/3) blieb ~70 Jahre der beste; jüngste Decoupling-basierte Arbeiten (vgl. Guth–Maynard, Dok. [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen|22]]) beginnen, an Exponenten in verwandten Dichteabschätzungen zu rütteln.
...
Eine Region σ > 1 − η(t) liefert via Konturverschiebung (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]])
```
...
- **ist schwächer als** → [[Riemann-Vermutung (RH)]] — *Nullstellenfreie Region ist weit schwächer als RH.*
