...
tags:
  ...
  - "kategorie/spectral"
  - "status/open"
  - "thema/bender-brody-muller"
  - "thema/hamiltonian"
  - "thema/pt-symmetry"
quelle: docs/09_Bender_Brody_Muller_2017_Hamiltonian.md
---

> [!info] Navigation
> **Karte:** [[MOC C – Spektrale Ansätze ∕ Hilbert–Pólya-Programm]] · **Kategorie:** Spektrale Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/09_Bender_Brody_Muller_2017_Hamiltonian.md`
...
## Kernidee
- Der Operator ist eine **Verallgemeinerung des Berry–Keating xp-Operators** (Dok. [[08 Berry–Keating H = xp Modell (Quantenchaos-Ansatz)|08]]).
