...
tags:
  ...
  - "thema/newman"
  - "thema/polya"
  - "thema/statistical-mechanics"
quelle: docs/33_statistical_mechanics_Lee_Yang.md
---

> [!info] Navigation
> **Karte:** [[MOC L – Weitere aktive Lösungsprogramme (potenziell beweisrelevant)]] · **Kategorie:** Lösungsprogramme · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/33_statistical_mechanics_Lee_Yang.md`
...
- Newman (1976) führte die **Wärmeleitungs-Deformation** H_t der ξ-Funktion ein (Faltung von Φ mit einem Gauß-Kern) und bewies die Existenz der **de-Bruijn–Newman-Konstante Λ**: H_t hat genau dann nur reelle Nullstellen, wenn t ≥ Λ. RH ⟺ Λ ≤ 0 (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]).
...
- **Lehmer-Paare** (extrem nahe beieinanderliegende Nullstellen) sind die "kritischen Konfigurationen", die zeigen, wie knapp die Reellwurzeligkeit erhalten bleibt — sie lieferten Rodgers–Tao (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]) den Hebel für Λ ≥ 0.
...
- Verbindet drei Stränge: Pólya/Laguerre–Pólya (Dok. [[29 Jensen–Pólya-Programm – Laguerre–Pólya-Klasse & Jensen-Polynome (Griffin–Ono–Rolen–Zagier 2019)|29]]), de-Bruijn–Newman (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]) und Random-Matrix/Quantenchaos (Dok. [[06 Montgomery-Paarkorrelation & Random-Matrix-Theorie (GUE)|06]]–[[08 Berry–Keating H = xp Modell (Quantenchaos-Ansatz)|08]]).
...
ξ ist die Fourier-(Laplace-)Transformierte der **positiven, geraden** Dichte Φ (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]):
```
...
### Wärmefluss und Newmans Λ (Verbindung zu Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]])
...
Zwei Nullstellen γ_n, γ_{n+1} mit Abstand ≪ Mittelwert bilden ein **Lehmer-Paar**; im Coulomb-Gas-Bild sind sie „fast kollidierende" Teilchen. Ihre Existenz (z. B. bei γ ≈ 7005,06) zeigt, dass die Reellheit nur knapp gehalten wird — der Hebel für Rodgers–Tao Λ ≥ 0 (Dok. [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15|23]]).
...
- **nutzt** → [[23 De-Bruijn–Newman-Konstante – Rodgers–Tao & Polymath15]] — *Statistische Mechanik liefert Werkzeuge für die dBN-Konstante.*
