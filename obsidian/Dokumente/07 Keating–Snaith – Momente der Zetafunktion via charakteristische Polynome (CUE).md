...
tags:
  ...
  - "thema/barnes-g"
  - "thema/cue"
  - "thema/keating-snaith"
  - "thema/moments"
  - "thema/random-matrix"
quelle: docs/07_Keating_Snaith_moments.md
---

> [!info] Navigation
> **Karte:** [[MOC C – Spektrale Ansätze ∕ Hilbert–Pólya-Programm]] · **Kategorie:** Spektrale Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/07_Keating_Snaith_moments.md`
...
- Macht die Zeta–GUE-Korrespondenz *quantitativ* und *vorhersagekräftig* (nicht nur Paarkorrelation wie bei Montgomery, Dok. [[06 Montgomery-Paarkorrelation & Random-Matrix-Theorie (GUE)|06]]).
- Liefert tiefe strukturelle Evidenz für einen spektralen/Random-Matrix-Ursprung der Nullstellen.
- Trägt indirekt zur RH bei (Momentschranken ↔ Anteil der Nullstellen auf der Geraden, Dok. [[04 Levinson, Conrey & Co. – Positiver Anteil der Nullstellen auf der kritischen Geraden|04]]), ist aber selbst kein Beweisweg zur vollen RH.
...
### Bezug zur RH
Momentschranken ⇒ untere Schranken für N₀(T)/N(T) (Anteil auf der Geraden, Dok. [[04 Levinson, Conrey & Co. – Positiver Anteil der Nullstellen auf der kritischen Geraden|04]]); k = 0-Verhalten ↔ Wertverteilung. Selbst die volle Momentvermutung impliziert die RH nicht, ist aber Teil desselben spektralen Bildes.
...
- **wird genutzt von** ← [[53 Paarkorrelation ohne RH & die Alternative Hypothese (Goldston, Lee, Schettler, Suriajaya, Baluyot, Turnage-]] — *Teilt den Random-Matrix-Rahmen mit Keating-Snaith.*
- **wird gestützt durch** ← [[49 Live-Front der analytischen Zahlentheorie (2019–2026)]] — *Harper/Radziwiłł–Soundararajan: scharfe Momentschranken stützen Keating-Snaith.*
