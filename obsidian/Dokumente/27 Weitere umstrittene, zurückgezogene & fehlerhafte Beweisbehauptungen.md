...
nummer: "27"
kategorie: Gescheiterte Beweise
status: WIDERLEGT
typ: dokument
aliases:
  - "doc-27"
...
tags:
  - "dokument"
  - "kategorie/failed-proof"
  - "status/refuted"
  - "thema/crackpot"
  - "thema/disputed-proofs"
  - "thema/error-patterns"
  - "thema/retracted"
quelle: docs/27_other_disputed_claimed_proofs.md
---

> [!info] Navigation
> **Karte:** [[MOC J – Gescheiterte ∕ umstrittene Beweise]] · **Kategorie:** Gescheiterte Beweise · **Status:** `WIDERLEGT`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/27_other_disputed_claimed_proofs.md`
...
## Zusammenfassung
Die Riemann-Vermutung zieht eine außergewöhnlich große Zahl an Beweis- (und Widerlegungs-)Behauptungen an — vom ernsthaften Forschungsprogramm bis zur offensichtlich fehlerhaften Einzelarbeit. **Stand Juni 2026 ist keine als gültig akzeptiert; die RH ist formal offen.** Dieses Dokument sammelt Muster und konkrete Beispiele; die prominenten Einzelfälle de Branges (Dok. [[20 Louis de Branges – Hilberträume ganzer Funktionen (mehrfach gescheiterte Beweise)|20]]), Atiyah (Dok. [[25 Michael Atiyah (2018) – gescheiterter Beweisversuch (Todd-Funktion)|25]]) und Nash (Dok. [[26 John Nash (1959) – gescheiterter Versuch|26]]) haben eigene Dokumente.
...
- **Nicht etablierte Positivität:** eine Positivitätsbedingung (Li/Weil-Typ, Dok. [[14 Li-Kriterium, Bombieri–Lagarias & Weil-Positivität|14]]) wird behauptet, aber nicht bewiesen.
...
- **Numerik statt Beweis:** endliche numerische Evidenz wird als Beweis ausgegeben (vgl. Mertens-Warnung, Dok. [[16 Mertens-Funktion & Riesz-Kriterium (Möbius-basierte Kriterien)|16]]).
...
- Diverse Preprints leiten die RH aus physikalischen "Kopplungskonstanten-Spektren" oder ML-Mustern ab (z. B. arXiv 2103.02223, 0803.1818). Diese sind heuristisch/spekulativ und liefern keinen formalen Beweis (vgl. Dok. [[28 KI ∕ Machine Learning und die Riemann-Vermutung|28]] zur kritischen Einordnung von KI-Ansätzen).
...
Häufig wird die explizite Formel (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]]) manipuliert, etwa
```
...
Bei Li/Weil-artigen Beweisen (Dok. [[14 Li-Kriterium, Bombieri–Lagarias & Weil-Positivität|14]]) wird λ_n = Σ_ρ[1−(1−1/ρ)^n] ≥ 0 „gezeigt", indem die zu beweisende Lage Re(ρ)=1/2 in einem Zwischenschritt schon benutzt wird:
```
...
- **wird widerlegt durch** → [[Riemann-Vermutung (RH)]] — *Diverse zurückgezogene/fehlerhafte Behauptungen.*
...
- [[25 Michael Atiyah (2018) – gescheiterter Beweisversuch (Todd-Funktion)]]
- [[26 John Nash (1959) – gescheiterter Versuch]]
