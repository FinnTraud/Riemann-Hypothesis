...
tags:
  ...
  - "status/open"
  - "thema/de-bruijn-newman"
  - "thema/lehmer-pairs"
  - "thema/polymath15"
  - "thema/rodgers-tao"
quelle: docs/23_de_Bruijn_Newman_constant_Polymath15.md
---

> [!info] Navigation
> **Karte:** [[MOC H – Aktuelle Durchbrüche]] · **Kategorie:** Durchbrüche · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/23_de_Bruijn_Newman_constant_Polymath15.md`
...
## Die Resultate
- **Rodgers–Tao (2018, "The de Bruijn–Newman constant is non-negative"):** Beweis von **Λ ≥ 0** (Newmans Vermutung). Veröffentlicht in *Forum of Mathematics, Pi* (2020). Idee: Wäre Λ < 0, hätten die Nullstellen eine "zu geordnete" Dynamik, die der bekannten GUE-artigen Statistik (Dok. [[06 Montgomery-Paarkorrelation & Random-Matrix-Theorie (GUE)|06]]) widerspricht.
...
**Beweisidee (Widerspruch).** Wäre Λ < 0, so wären die Nullstellen für ein t < 0 schon reell und würden unter dem Fluss zu t = 0 eine *zu reguläre* Verteilung annehmen: Man zeigt, dass dann die Nullstellen asymptotisch in nahezu arithmetischer Progression lägen (Abstände gleichmäßiger als erlaubt). Das widerspricht der bekannten **Paarkorrelations-/Montgomery-Statistik** (Dok. [[06 Montgomery-Paarkorrelation & Random-Matrix-Theorie (GUE)|06]]), die Niveau-Abstoßung *und* Fluktuationen verlangt. Formal: eine Größe (gemittelte Nullstellendynamik) müsste zugleich → 0 und ≥ c > 0 sein. ⇒ Λ ≥ 0.
...
- **ist äquivalent zu** → [[Riemann-Vermutung (RH)]] — *de-Bruijn–Newman: Λ≤0 ⟺ RH.*

### Eingehende Relationen

- **wird genutzt von** ← [[29 Jensen–Pólya-Programm – Laguerre–Pólya-Klasse & Jensen-Polynome (Griffin–Ono–Rolen–Zagier 2019)]] — *Laguerre-Pólya ⟺ Λ≤0; gemeinsame Pólya-Wurzel.*
- **wird genutzt von** ← [[33 Statistische Mechanik & Lee–Yang-Analogie (Newman)]] — *Statistische Mechanik liefert Werkzeuge für die dBN-Konstante.*

### Belegte Aussagen (Claims)

- `[BEWIESEN]` [[claim-dbn-equiv]] — RH ⟺ Λ ≤ 0 (de-Bruijn–Newman-Konstante).
- `[BEWIESEN]` [[claim-dbn-lower]] — Λ ≥ 0 (die RH ist, falls wahr, nur knapp wahr).
- `[BEWIESEN]` [[claim-dbn-upper]] — Λ ≤ 0.22.
