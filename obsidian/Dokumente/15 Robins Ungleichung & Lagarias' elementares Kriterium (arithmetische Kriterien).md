...
tags:
  ...
  - "kategorie/criterion"
  - "status/open"
  - "thema/divisor-function"
  - "thema/elementary"
  - "thema/lagarias"
  - "thema/robin"
quelle: docs/15_Robin_inequality.md
---

> [!info] Navigation
> **Karte:** [[MOC D – Analytische Ansätze & äquivalente Kriterien]] · **Kategorie:** Äquivalente Kriterien · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/15_Robin_inequality.md`
...
```
**Beweisrichtung „RH ⇒ Ungleichung" (Skizze):** Robin nutzt explizite Abschätzungen der Chebyshev-Funktion θ(x)=Σ_{p≤x} log p, die unter RH den Fehlerterm θ(x) = x + O(√x log²x) (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]]) haben. Für „kolossal abundante" Zahlen (die σ(n)/(n log log n) maximieren) übersetzt sich dieser Fehlerterm in die scharfe Konstante e^γ. **Gegenrichtung:** Wäre RH falsch (Nullstelle mit β>1/2), so konstruiert man eine Folge von n, die die Ungleichung verletzt.
...
- **ist äquivalent zu** → [[Riemann-Vermutung (RH)]] — *Robin/Lagarias-Ungleichung ⟺ RH.*

### Belegte Aussagen (Claims)

- `[BEWIESEN]` [[claim-robin]] — RH ⟺ σ(n) < e^γ·n·log log n für alle n>5040.
