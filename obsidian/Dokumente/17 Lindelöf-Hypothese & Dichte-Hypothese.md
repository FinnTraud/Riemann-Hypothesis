...
tags:
  ...
  - "kategorie/analytic"
  - "status/open"
  - "thema/density-hypothesis"
  - "thema/lindelof"
  - "thema/mu-exponent"
  - "thema/subconvexity"
quelle: docs/17_Lindelof_density_hypothesis.md
---

> [!info] Navigation
> **Karte:** [[MOC D – Analytische Ansätze & äquivalente Kriterien]] · **Kategorie:** Analytische Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/17_Lindelof_density_hypothesis.md`
...
- **Fortschritte:** explizite log-freie Dichteabschätzungen (z. B. arXiv 2405.12545), Ingham, Huxley, und insbesondere der **Guth–Maynard-Durchbruch (2024)** für σ nahe 3/4 (Dok. [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen|22]]).
...
```
(vgl. Keating–Snaith (log T)^{k²}, Dok. [[07 Keating–Snaith – Momente der Zetafunktion via charakteristische Polynome (CUE)|07]] — verträglich, da T^ε jedes log-Potenzwachstum dominiert.)
...
```
Klassisch (Ingham 1940): N(σ,T) ≪ T^{3(1−σ)/(2−σ)+ε}. **Log-freie** Form: N(σ,T) ≪ A·T^{B(1−σ)}. Guth–Maynard (2024, Dok. [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen|22]]) verbessern den Exponenten nahe σ = 3/4 (N(3/4,T) ≪ T^{13/25+o(1)} statt T^{3/5+o(1)}).
...
- **ist schwächer als** → [[Riemann-Vermutung (RH)]] — *Lindelöf ist schwächer; Rückrichtung unbekannt.*

### Eingehende Relationen

- **wird genutzt von** ← [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen]] — *Guth–Maynard verbessert Dichte-Abschätzungen Richtung Dichte-Hypothese.*
- **wird gestützt durch** ← [[49 Live-Front der analytischen Zahlentheorie (2019–2026)]] — *Subkonvexität nähert Lindelöf an.*
- **wird impliziert von** ← [[Riemann-Vermutung (RH)]] — *RH ⇒ Lindelöf-Hypothese.*

### Belegte Aussagen (Claims)

- `[OFFEN]` [[claim-lindelof]] — RH ⟹ Lindelöf-Hypothese ζ(1/2+it)=O(t^ε); Rückrichtung unbekannt.
