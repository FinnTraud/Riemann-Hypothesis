...
tags:
  ...
  - "thema/2025"
  - "thema/2026"
  - "thema/additive-energy"
  - "thema/antedb"
  - "thema/autoformalization"
  - "thema/exponent-pairs"
  - "thema/gauss"
  - "thema/kontorovich"
  - "thema/lean"
  - "thema/mathlib"
  - "thema/reproducibility"
  - "thema/tao"
  - "thema/trudgian"
  - "thema/yang"
  - "thema/zero-density"
quelle: docs/54_machine_assisted_number_theory_ANTEDB_Lean.md
---

> [!info] Navigation
> **Karte:** [[MOC O – Aktuelle Front 2025–2026 (Recherche-Update August 2026)]] · **Kategorie:** Meta · **Status:** `REFERENZ`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/54_machine_assisted_number_theory_ANTEDB_Lean.md`
...
beschreiben, das der MCP-Server hier erzwingt (Dok. [[50 Denkprotokoll – strukturiert-analytisches Arbeiten an der RH|50]]): Ergebnisse als *Daten*, Beziehungen als
...
Zur Erinnerung die betroffene Größe (vgl. Dok. [[49 Live-Front der analytischen Zahlentheorie (2019–2026)|49]]):
```
...
```
die Guth–Maynard (Dok. [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen|22]]) als Zwischengröße benutzen. ANTEDB macht diese Landschaft
maschinenlesbar — dieselbe Idee wie der Wissensgraph in `kb/graph/`, nur für Exponenten statt
für Konzepte.

### 2) Explizite und log-freie Dichteabschätzungen (Fortschreibung von Dok. [[49 Live-Front der analytischen Zahlentheorie (2019–2026)|49]])
...
gestiegen. Dok. [[37 Formalisierung – Lean, mathlib & Proof Assistants (Verifikations-Infrastruktur)|37]] argumentiert, dass Lean/mathlib das natürliche „Gateway" für jeden künftigen
...
Im Umfeld der Weil-Form-Numerik (Dok. [[52 Abgeschnittene Weil-Quadratform & Zeta-Spektraltripel (Connes–van Suijlekom, Connes–Consani–Moscovici, 2025|52]]) liefern Preprints inzwischen vollständige Pakete mit:
...
- **Konkrete Anschlussaufgaben** (im Sinne von Dok. [[51 Kollaborations-Leitfaden – sinnvoll mit einer Fachperson an der RH arbeiten|51]]): ANTEDB-Exponenten in den Wissensgraph
...
- Dok. [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen|22]] (Guth–Maynard), 49 (Live-Front) — die Resultate, die ANTEDB systematisiert
- Dok. [[24 Numerische Verifikation der Riemann-Vermutung|24]] (numerische Verifikation) — Rigorosität von Rechnungen (Platt-Standard)
- Dok. [[28 KI ∕ Machine Learning und die Riemann-Vermutung|28]] (KI und RH), 37 (Formalisierung), 50 (Denkprotokoll) — der Methodenrahmen
- Dok. [[51 Kollaborations-Leitfaden – sinnvoll mit einer Fachperson an der RH arbeiten|51]] (Kollaborations-Leitfaden), Dok. [[52 Abgeschnittene Weil-Quadratform & Zeta-Spektraltripel (Connes–van Suijlekom, Connes–Consani–Moscovici, 2025|52]] (Weil-Form-Numerik) — wo man andocken kann
...
- **ist Evidenz für** → [[28 KI ∕ Machine Learning und die Riemann-Vermutung]] — *Autoformalisierung als konkreter KI-Beitrag im RH-Umfeld.*
- **ist Evidenz für** → [[37 Formalisierung – Lean, mathlib & Proof Assistants (Verifikations-Infrastruktur)]] — *Der formalisierte starke Primzahlsatz zeigt, dass Lean analytische Zahlentheorie traegt.*
- **nutzt** → [[22 Guth–Maynard (2024) – Durchbruch bei Nullstellendichte-Abschätzungen]] — *Additive Energie der Nullstellen ist die Guth-Maynard-Zwischengroesse.*
- **nutzt** → [[24 Numerische Verifikation der Riemann-Vermutung]] — *Rigorose Verifikationsstandards (Platt, Intervall-Zertifikate).*
- **nutzt** → [[49 Live-Front der analytischen Zahlentheorie (2019–2026)]] — *Systematisiert und verschaerft die Resultate der Live-Front.*

### Eingehende Relationen

- **hat als Instanz** ← [[Formale Verifikation ∕ maschinengestuetzte Mathematik]] — *Dok. 54 beschreibt ANTEDB, Lean-PNT und Zertifikate.*

### Belegte Aussagen (Claims)

- `[BEWIESEN]` [[claim-lean-pnt]] — Der starke Primzahlsatz (mit Fehlerterm) ist in Lean 4 vollstaendig formalisiert (ca. 25 000 Zeilen, 1000+ Saetze/Definitionen).
- `[BEWIESEN]` [[claim-antedb]] — Systematische Optimierung ueber die Analytic Number Theory Exponent Database (ANTEDB) liefert vier neue Exponentenpaare sowie neue Nullstellendichte- und additive-Energie-Abschaetzungen fuer zeta - unbedingt.
...
- [[52 Abgeschnittene Weil-Quadratform & Zeta-Spektraltripel (Connes–van Suijlekom, Connes–Consani–Moscovici, 2025]]
