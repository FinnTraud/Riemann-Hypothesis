...
tags:
  ...
  - "thema/random-matrix"
quelle: docs/06_Montgomery_pair_correlation_RMT.md
---

> [!info] Navigation
> **Karte:** [[MOC C – Spektrale Ansätze ∕ Hilbert–Pólya-Programm]] · **Kategorie:** Spektrale Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/06_Montgomery_pair_correlation_RMT.md`
...
- Inspirierte die quantenchaotischen Modelle (Berry–Keating, Dok. [[08 Berry–Keating H = xp Modell (Quantenchaos-Ansatz)|08]]) und die Momentvermutungen (Keating–Snaith, Dok. [[07 Keating–Snaith – Momente der Zetafunktion via charakteristische Polynome (CUE)|07]]).
...
Wegen Dichte (1/2π)log(T/2π) (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]]) skaliert man die Imaginärteile γ auf mittleren Abstand 1:
```
γ̃ = γ · (1/2π) log(γ/2π)
```
...
- **hat als Instanz** ← [[Paarkorrelation der Nullstellen (Montgomery F(alpha,T))]] — *Dok. 06 fuehrt Montgomerys Paarkorrelation ein.*
- **wird verallgemeinert von** ← [[53 Paarkorrelation ohne RH & die Alternative Hypothese (Goldston, Lee, Schettler, Suriajaya, Baluyot, Turnage-]] — *Nimmt die RH-Annahme aus der Gallagher-Mueller-Methode heraus.*

### Belegte Aussagen (Claims)

- `[OFFEN]` [[claim-montgomery]] — Paarkorrelation der Nullstellen = GUE-Kern 1−(sin πu/πu)² (unter RH, |α|≤1).
