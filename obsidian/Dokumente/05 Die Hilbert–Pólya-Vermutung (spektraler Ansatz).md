...
tags:
  ...
  - "status/open"
  - "thema/hilbert-polya"
  - "thema/self-adjoint-operator"
  - "thema/spectral"
quelle: docs/05_Hilbert_Polya_conjecture.md
---

> [!info] Navigation
> **Karte:** [[MOC C – Spektrale Ansätze ∕ Hilbert–Pólya-Programm]] · **Kategorie:** Spektrale Ansätze · **Status:** `OFFEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/05_Hilbert_Polya_conjecture.md`
...
- Indirekte Evidenz: Die statistische Verteilung der Nullstellen passt exakt zu Eigenwert-Statistiken großer Zufallsmatrizen (GUE), was mit der Existenz eines "chaotischen" selbstadjungierten Operators konsistent ist (siehe Dok. [[06 Montgomery-Paarkorrelation & Random-Matrix-Theorie (GUE)|06]]).
- Konkrete Operator-Kandidaten / Teil-Realisierungen:
  - **Berry–Keating H = xp** Modell (Dok. [[08 Berry–Keating H = xp Modell (Quantenchaos-Ansatz)|08]]).
  - **Bender–Brody–Müller** PT-symmetrischer Hamiltonian (Dok. [[09 Bender–Brody–Müller (2017) – PT-symmetrischer Hamiltonian für die Riemann-Nullstellen|09]]).
  - **Connes'** spektrale Realisierung in der nichtkommutativen Geometrie (Dok. [[10 Alain Connes – Spurformel & nichtkommutative Geometrie|10]]).
  - **Connes–Moscovici** Prolate-Spheroidal-Operator als "konkrete annähernde Lösung der Hilbert–Pólya-Vermutung" (Dok. [[11 Connes–Moscovici – Prolate-Spheroidal-Operator und Zeta (2021–2022)|11]]).
...
```
Vergleich mit Weils expliziter Formel (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]]) ⇒ die „periodischen Orbits" entsprechen den Primzahlen, Längen = log p. Das ist die strukturelle Brücke, die Berry–Keating (Dok. [[08 Berry–Keating H = xp Modell (Quantenchaos-Ansatz)|08]]), Connes (Dok. [[10 Alain Connes – Spurformel & nichtkommutative Geometrie|10]]) und Deninger (Dok. [[31 Deningers Kohomologie-Programm & dynamische Systeme auf gefolierten Räumen|31]]) konkret zu realisieren versuchen.

### Pólyas analytischer Vorläufer (Laguerre–Pólya)
Eine dazu äquivalente, operatorfreie Fassung (Dok. [[29 Jensen–Pólya-Programm – Laguerre–Pólya-Klasse & Jensen-Polynome (Griffin–Ono–Rolen–Zagier 2019)|29]]): RH ⟺ ξ liegt in der **Laguerre–Pólya-Klasse** (ganze Funktionen mit nur reellen Nullstellen, Grenzwerte von Polynomen ∏(1 − x/x_k) mit x_k ∈ ℝ). „Reelles Spektrum" und „reelle Nullstellen von ξ" sind dieselbe Aussage in zwei Sprachen.
