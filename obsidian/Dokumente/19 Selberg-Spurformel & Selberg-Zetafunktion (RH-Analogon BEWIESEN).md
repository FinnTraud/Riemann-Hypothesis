...
tags:
  ...
  - "thema/selberg-zeta"
  - "thema/trace-formula"
quelle: docs/19_Selberg_trace_formula_zeta.md
---

> [!info] Navigation
> **Karte:** [[MOC E – Bewiesene Analoga (algebraisch∕geometrisch)]] · **Kategorie:** Bewiesene Analoga · **Status:** `BEWIESEN`
> **Zentrale Notiz:** [[Riemann-Wissensnetz]] · **Original:** `docs/19_Selberg_trace_formula_zeta.md`
...
| Selberg-Spurformel | Weils explizite Formel (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]]) |
| Selbstadjungierter Laplace ⇒ RH-Analogon | gesuchter Hilbert–Pólya-Operator (Dok. [[05 Die Hilbert–Pólya-Vermutung (spektraler Ansatz)|05]]) |
...
- Connes formulierte explizit: Ein passendes Analogon der Selberg-Spurformel für die Wirkung der Idèleklassengruppe auf den Adèleklassenraum würde die RH implizieren (Dok. [[10 Alain Connes – Spurformel & nichtkommutative Geometrie|10]]).
...
### Wörterbuch zur expliziten Formel (Dok. [[02 Riemann–von-Mangoldt-Formel und die explizite Formel|02]])
...
**Kernbotschaft:** In der Selberg-Welt *existiert* der selbstadjungierte Operator (Δ) und liefert das RH-Analogon umsonst. Das ist die Blaupause, die Connes (Dok. [[10 Alain Connes – Spurformel & nichtkommutative Geometrie|10]]) und Deninger (Dok. [[31 Deningers Kohomologie-Programm & dynamische Systeme auf gefolierten Räumen|31]]) für ζ zu realisieren suchen.
...
- `[BEWIESEN]` [[claim-selberg-zeta]] — Das RH-Analogon für die Selberg-Zetafunktion ist wahr (Laplace selbstadjungiert).
