...
source_file: 57_Beurling_generalized_primes.md
lang: de
---
...
kann die RH liefern — denn genau diese Zutaten hat das DMV-System, und dort ist die Aussage falsch. Was den Beurling-Systemen fehlt, ist die **additive** Struktur von ℤ: Es gibt keine Funktionalgleichung, keine Poisson-Summation, keine Modularität, kein θ-Funktions-Argument (Dok. 62).
...
- Erklärt, warum rein **siebtheoretische** oder rein **multiplikative** Zugänge (Dok. 58) an der RH scheitern müssen.
...
**Hebel (was er liefern würde):** Zweite Säule der Einkreisung neben Davenport-Heilbronn.

**Typische Fehlermodi:** [[F1_no-euler-product|F1 Euler-Produkt nicht wesentlich benutzt]]

**Vergleichbar mit:** [[62_Tate_thesis_adelic_analysis|Tates These & adelische Analysis: warum die Funktionalgleichung „billig\" ist]] · [[04_Levinson_Conrey_positive_proportion|Levinson, Conrey & Co.: Positiver Anteil der Nullstellen auf der kritischen Geraden]] · [[46_Voronin_universality|Voronin-Universalität (Meta-Obstruktion gegen „weiche' Beweise)]]
> Vergleich abrufen: `python3 kb/compare.py compare doc-57 doc-62 doc-04 doc-46`

**Ausgehende Beziehungen**
- *ist Instanz von* (`instance_of`) → [[concept_euler-product|Euler-Produkt (Multiplikativität)]] — Beurling-Systeme haben ein Euler-Produkt per Konstruktion.
- *ist Obstruktion für* (`obstruction_for`) → [[concept_RH|Riemann-Vermutung (RH)]] — Euler-Produkt + gute Dichte reichen nicht: DMV-System verletzt das RH-Analogon.
- *verallgemeinert* (`generalizes`) → [[35_obstructions_barriers|35 — Obstruktionen & Barrieren: Warum naive Ansätze scheitern MÜSSEN]] — Zweite Säule neben Davenport–Heilbronn: auch Multiplikativität allein genügt nicht.
- *ist Obstruktion für* (`obstruction_for`) → [[12_zero_free_regions|12 — Nullstellenfreie Regionen (klassischer analytischer Ansatz)]] — Zeigt: die klassische nullstellenfreie Region ist im Beurling-Rahmen optimal.
- *ist schwächer als* (`weaker_than`) → [[62_Tate_thesis_adelic_analysis|62 — Tates These & adelische Analysis: warum die Funktionalgleichung „billig\" ist]] — Beurling-Systemen fehlt die additive Struktur (Poisson-Summation).

**Thematisch benachbart (gemeinsame Tags):** [[43_Epstein_zeta_Selberg_class_rigidity|Epstein-Zetafunktionen & Selberg-Klassen-Rigidität: Welche Eigenschaft erzwingt die kritische Gerade?]] · [[01_Riemann_1859_original_paper|Riemanns Originalarbeit (1859) und die Riemann-Siegel-Formel]]
