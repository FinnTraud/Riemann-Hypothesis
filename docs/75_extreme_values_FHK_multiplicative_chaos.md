...
source_file: 75_extreme_values_FHK_multiplicative_chaos.md
lang: de
---
...
2. **Falsifizierbarkeit.** Würde man numerisch Maxima finden, die deutlich über der FHK-Vorhersage liegen, wäre das ein Hinweis auf zusätzliche Struktur — und mögliche Nullstellen abseits der Geraden (Dok. 61).
...
4. **Technik-Transfer.** Die Momenten-Obergrenzen von Harper und Soundararajan (unter RH) sind Bausteine für die Splitting-Vermutung (Dok. 74) und für Dichteabschätzungen (Dok. 49).
...
> 
> **Hebel:** Scharfer, numerisch prüfbarer Konsistenztest für die RH.
> 
> **Fehlermodi:** [[F14_model-without-implication|F14 Zirkularität der Modellannahme]]
> 
> Vergleich: [[78_approach_comparison_matrix]] · `python3 kb/compare.py profile doc-75`
...
> - *ist Evidenz für* → [[17_Lindelof_density_hypothesis|17 · Lindelöf-Hypothese & Dichte-Hypothese]] — Extremwert-Schranken kalibrieren Lindelöf.
> - *ist Evidenz für* → [[23_de_Bruijn_Newman_constant_Polymath15|23 · De-Bruijn–Newman-Konstante]] — Extremwerte und Lehmer-Paare messen beide, wie 'knapp' die RH gilt.
> - *ist Instanz von* → **Momente & Zufallsmatrix-Modelle** — Momente und Maxima sind zwei Seiten derselben Statistik.
> - *benutzt* → [[74_hybrid_Euler_Hadamard_product|74 · Hybrides Euler–Hadamard-Produkt]] — Zerlegung in Primzahl- und Nullstellenanteil ist der technische Kern.
