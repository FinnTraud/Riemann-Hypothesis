...
source_file: 74_hybrid_Euler_Hadamard_product.md
lang: de
---
...
> 
> **Hebel:** Erklärt strukturell, warum RMT funktioniert und wo die Arithmetik sitzt.
> 
> **Fehlermodi:** [[F14_model-without-implication|F14 Zirkularität der Modellannahme]]
> 
> Vergleich: [[78_approach_comparison_matrix]] · `python3 kb/compare.py profile doc-74`
...
> - *ist Instanz von* → **Momente & Zufallsmatrix-Modelle** — Erklärt die Faktorisierung a_k·g_k der Momentenvermutung.
> - *modelliert* → [[06_Montgomery_pair_correlation_RMT|06 · Montgomery-Paarkorrelation & Random-Matrix-Theorie]] — Trennt arithmetischen von spektralem Anteil der Statistik.
> - *reduziert sich auf* → [[07_Keating_Snaith_moments|07 · Keating–Snaith]] — Strukturelle Begründung der Keating–Snaith-Vorhersage.
> - *benutzt* → **Euler-Produkt (Multiplikativität)** — Kurzes Euler-Produkt P_X als arithmetischer Faktor.
> - ← *wird benutzt von* [[75_extreme_values_FHK_multiplicative_chaos|75 · Extremwerte von ζ]] — Zerlegung in Primzahl- und Nullstellenanteil ist der technische Kern.
